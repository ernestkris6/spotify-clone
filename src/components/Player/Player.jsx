    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            ...
            <div className='flex items-center gap-5'>
                <p>{time.currentTime.minute < 10 && "0"}{time.currentTime.minute}:{time.currentTime.second < 10 && "0"}{time.currentTime.second}</p>
                <div ref={seekBg} onClick={seekSong} className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
                  <hr ref={seekBar} className='h-1 border-none w-0 bg-green-800 rounded-full'></hr>
                </div>
                <p>{time.totalTime.minute < 10 && "0"}{time.totalTime.minute}:{time.totalTime.second}{time.totalTime.second < 10 && "0"}</p>
            </div>
        </div>
        <div className='hidden lg:flex items-center gap-2 opacity-75'>
            ...
            <div className='w-20 bg-slate-50 cursor-pointer h-1 rounded'>
